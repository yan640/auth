...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final String APP_PREFERENCES_PHONE  = "APP_PREFERENCES_PHONE";
    private static final String APP_PREFERENCES_FBID  = "APP_PREFERENCES_FBID";
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        ...
        if (user == null) {
            ...
            */
            ...
            sharedPref2.OnStartAppCheck(user.getPhoneNumber(),user.getUid());
